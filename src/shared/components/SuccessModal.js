  ...
  return (
    ...
    >
      <div className="w-full max-w-[448px] rounded-[24px] bg-white px-10 pb-12 pt-16 text-center shadow-[0_26px_90px_rgba(15,23,42,0.16)] sm:px-11">
        ...
        <h2
          id="hearing-success-title"
          className="mt-10 text-xl font-bold text-gray-950"
        >
          {title}
        </h2>
        ...
        <button
          type="button"
          onClick={onDone}
          className="mt-11 flex h-12 w-full items-center justify-center gap-4 rounded-lg bg-variable-collection-primary-color text-base font-bold text-white shadow-lg transition hover:bg-[#344878]"
        >
