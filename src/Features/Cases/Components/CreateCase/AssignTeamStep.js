...
export default function AssignTeamStep({
  formData,
  setFormData,
  errors,
  onBack,
  ...
  const isSelected = formData.team?.[0]?.user_id === user.ID;
  return (
    <div className="w-full bg-white rounded-2xl pb-6">
      {/* Header */}
      <StepHeader icon={<PersonSearchIcon />} title="تعيين الفريق " />
